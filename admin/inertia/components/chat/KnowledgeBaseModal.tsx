    ...
    openModal(
      ...
      >
        <p className='text-gray-700'>
          This will scan the system's storage directories for any new files and queue them for processing. This is useful if you've manually added files to the storage or want to ensure everything is up to date.
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      When you upload documents to your Knowledge Base, The Attic AI processes and embeds
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      The Attic AI includes built-in Optical Character Recognition (OCR) capabilities,
                      ...
                      format, The Attic AI can still process and embed their content for AI access.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-desert-stone">
                      The Attic AI will automatically discover and extract any content you save to your
